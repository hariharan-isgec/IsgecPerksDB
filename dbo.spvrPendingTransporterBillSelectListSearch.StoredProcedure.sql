...
GO
CREATE PROCEDURE [dbo].[spvrPendingTransporterBillSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 ,IRNo Int NOT NULL
  ...
  SELECT [VR_TransporterBill].[IRNo] FROM [VR_TransporterBill]
 ...
 WHERE  
      [VR_TransporterBill].[BillStatusID] = (@BillStatusID)
   AND ( 
         STR(ISNULL([VR_TransporterBill].[IRNo], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[IRDescription],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[ISGECPONumber],'')) LIKE @KeyWord1
     OR STR(ISNULL([VR_TransporterBill].[ISGECPOAmount], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[TransporterID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[TransporterBillNo],'')) LIKE @KeyWord1
     OR STR(ISNULL([VR_TransporterBill].[BillAmount], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[BillReceivedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[BillReceiverDivisionID],'')) LIKE @KeyWord1
     OR STR(ISNULL([VR_TransporterBill].[BillStatusID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[BillReturnRemarks],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[BillReturneddBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[ReceiptNo],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[ReceiptLine],'')) LIKE @KeyWord1
     OR STR(ISNULL([VR_TransporterBill].[PassedAmount], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[ForwardedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[ReceiptAcknowledgedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[ReceiptReturnedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([VR_TransporterBill].[ReceiptReturnRemarks],'')) LIKE @KeyWord1
     OR STR(ISNULL([VR_TransporterBill].[SerialNo], 0)) LIKE @KeyWord1
   ) 
  ORDER BY

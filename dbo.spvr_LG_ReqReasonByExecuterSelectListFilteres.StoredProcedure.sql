...
GO
CREATE PROCEDURE [dbo].[spvr_LG_ReqReasonByExecuterSelectListFilteres]
 ...
 ,RequestNo Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + ' AND ([VR_VehicleRequest].[RequestStatus] >= 4 AND [VR_VehicleRequest].[RequestStatus] <= 7)  ' 

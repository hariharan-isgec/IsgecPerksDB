...
GO
CREATE PROCEDURE [dbo].[sptosOTPTasksSelectListSearch]
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
  @OrderBy NVarChar(50),
 ...
 ,TaskID Int NOT NULL
  ...
  SELECT [TOS_Tasks].[ProjectID], [TOS_Tasks].[TaskID] FROM [TOS_Tasks]
 ...
 WHERE  
   ( 
         LOWER(ISNULL([TOS_Tasks].[ProjectID],'')) LIKE @KeyWord1
     OR STR(ISNULL([TOS_Tasks].[TaskID], 0)) LIKE @KeyWord1

...
GO
CREATE PROCEDURE [dbo].[spqap_LG_RequestsSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 WHERE [QAP_Requests].[CreatersDivision] = (SELECT TOP 1 [aspnet_Users].[C_DivisionID] FROM [aspnet_Users] WHERE [aspnet_Users].[LoginID]= @LoginID )  
   AND  ( 

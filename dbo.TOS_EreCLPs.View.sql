...
SELECT     TOP (100) PERCENT dbo.TOS_Projects.ProjectID, dbo.TOS_Projects.Description AS ProjectName, dbo.TOS_CLPDataDetails.CLPID, 
                      ...
                      dbo.TOS_CLPDataDetails.Sequence, DATEDIFF(d, dbo.TOS_CLPDataDetails.ereEndtDefined, dbo.TOS_CLPDataDetails.ereEndtActual) AS DelayDays, 
                      ...
                      dbo.TOS_FunctionalArea.Description AS FunctionalArea, dbo.TOS_CLPDataDetails.ereEndtDefined, dbo.TOS_CLPDataDetails.ereEndtActual, 
                      dbo.TOS_CLPDataDetails.eredelayStatus
FROM         dbo.TOS_CLPDataDetails INNER JOIN
                      ...
                      dbo.TOS_Tasks ON dbo.TOS_CLPs.ProjectID = dbo.TOS_Tasks.ProjectID AND dbo.TOS_CLPs.ereTaskID = dbo.TOS_Tasks.TaskID INNER JOIN

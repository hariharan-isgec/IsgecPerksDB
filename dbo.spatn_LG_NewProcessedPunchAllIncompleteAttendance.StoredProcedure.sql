...
GO
CREATE Procedure [dbo].[spatn_LG_NewProcessedPunchAllIncompleteAttendance]
  @CardNo NVarChar(8),
  @FinYear NVarChar(4),
...
--  AND ((MONTH([ATN_Attendance].[AttenDate]) >= MONTH(GETDATE()) - 2) AND YEAR([ATN_Attendance].[AttenDate]) = @FinYear)  

...
GO
CREATE PROCEDURE [dbo].[sptaBillDetailsSelectListFilteres]
  @Filter_TABillNo Int,
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
 ...
 ,SerialNo Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'AmountRateOU' THEN '[TA_BillDetails].[AmountRateOU]'
                        WHEN 'AmountRateOU DESC' THEN '[TA_BillDetails].[AmountRateOU] DESC'
                        WHEN 'AmountTaxOU' THEN '[TA_BillDetails].[AmountTaxOU]'
                        WHEN 'AmountTaxOU DESC' THEN '[TA_BillDetails].[AmountTaxOU] DESC'
                        WHEN 'ConversionFactorOU' THEN '[TA_BillDetails].[ConversionFactorOU]'
                        WHEN 'ConversionFactorOU DESC' THEN '[TA_BillDetails].[ConversionFactorOU] DESC'
                        WHEN 'CurrencyMain' THEN '[TA_BillDetails].[CurrencyMain]'
                        WHEN 'CurrencyMain DESC' THEN '[TA_BillDetails].[CurrencyMain] DESC'

...
GO
CREATE PROCEDURE [dbo].[spPrkApplicationsSelectListPagedByFilteres]
  @StartRowIndex int,
  @MaximumRows int,
  @FinYear Int,
  @OrderBy NVarChar(50),
  ...
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[ApprovedBy] = [PRK_Employees3].[EmployeeID]'
  SET @LGSQL = @LGSQL + '  LEFT OUTER JOIN [PRK_Employees] AS [PRK_Employees6]'
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[UpdatedBy] = [PRK_Employees6].[EmployeeID]'
  ...
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[VerifiedBy] = [PRK_Employees4].[EmployeeID]'
  SET @LGSQL = @LGSQL + '  INNER JOIN [PRK_Status] AS [PRK_Status7]'
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[StatusID] = [PRK_Status7].[StatusID]'
  SET @LGSQL = @LGSQL + '  INNER JOIN [PRK_FinYears] AS [PRK_FinYears8]'
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[FinYear] = [PRK_FinYears8].[FinYear]'
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'PRK_Employees6_CategoryID' THEN '[PRK_Employees6].[CategoryID]'
                        WHEN 'PRK_Employees6_CategoryID DESC' THEN '[PRK_Employees6].[CategoryID] DESC'
                        ...
                        WHEN 'PRK_Employees6_VehicleType' THEN '[PRK_Employees6].[VehicleType]'
                        WHEN 'PRK_Employees6_VehicleType DESC' THEN '[PRK_Employees6].[VehicleType] DESC'
                        WHEN 'PRK_Employees6_Basic' THEN '[PRK_Employees6].[Basic]'
                        WHEN 'PRK_Employees6_Basic DESC' THEN '[PRK_Employees6].[Basic] DESC'
                        WHEN 'PRK_Employees6_ESI' THEN '[PRK_Employees6].[ESI]'
                        WHEN 'PRK_Employees6_ESI DESC' THEN '[PRK_Employees6].[ESI] DESC'
                        WHEN 'PRK_Employees6_DOJ' THEN '[PRK_Employees6].[DOJ]'
                        WHEN 'PRK_Employees6_DOJ DESC' THEN '[PRK_Employees6].[DOJ] DESC'
                        WHEN 'PRK_Employees6_DOR' THEN '[PRK_Employees6].[DOR]'
                        WHEN 'PRK_Employees6_DOR DESC' THEN '[PRK_Employees6].[DOR] DESC'
                        ...
                        WHEN 'PRK_Status7_StatusID' THEN '[PRK_Status7].[StatusID]'
                        WHEN 'PRK_Status7_StatusID DESC' THEN '[PRK_Status7].[StatusID] DESC'
                        WHEN 'PRK_Status7_Description' THEN '[PRK_Status7].[Description]'
                        WHEN 'PRK_Status7_Description DESC' THEN '[PRK_Status7].[Description] DESC'
                        WHEN 'PRK_FinYears8_FinYear' THEN '[PRK_FinYears8].[FinYear]'
                        WHEN 'PRK_FinYears8_FinYear DESC' THEN '[PRK_FinYears8].[FinYear] DESC'
                        WHEN 'PRK_FinYears8_Description' THEN '[PRK_FinYears8].[Description]'
                        WHEN 'PRK_FinYears8_Description DESC' THEN '[PRK_FinYears8].[Description] DESC'
                        WHEN 'PRK_FinYears8_StartDate' THEN '[PRK_FinYears8].[StartDate]'
                        WHEN 'PRK_FinYears8_StartDate DESC' THEN '[PRK_FinYears8].[StartDate] DESC'
                        WHEN 'PRK_FinYears8_EndDate' THEN '[PRK_FinYears8].[EndDate]'
                        WHEN 'PRK_FinYears8_EndDate DESC' THEN '[PRK_FinYears8].[EndDate] DESC'
                        WHEN 'PRK_FinYears8_Status' THEN '[PRK_FinYears8].[Status]'
                        WHEN 'PRK_FinYears8_Status DESC' THEN '[PRK_FinYears8].[Status] DESC'

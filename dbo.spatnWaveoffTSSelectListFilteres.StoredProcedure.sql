...
GO
CREATE PROCEDURE [dbo].[spatnWaveoffTSSelectListFilteres]
  ...
  SET @LGSQL = @LGSQL + ' AND [ATN_Attendance].[PunchStatusID] = ''' + @PunchStatusID + ''''
  SET @LGSQL = @LGSQL + ' AND [ATN_Attendance].[Applied] = 0 '

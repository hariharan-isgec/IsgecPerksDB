...
GO
CREATE PROCEDURE [dbo].[spspmtAirTicketSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 ,SerialNo Int NOT NULL
  ...
  SELECT [SPMT_AirTicket].[SerialNo] FROM [SPMT_AirTicket]
 ...
 WHERE  
   ( 
         STR(ISNULL([SPMT_AirTicket].[SerialNo], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[TranTypeID],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsIsgecGSTIN], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgentsStateID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgentsBillNumber],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgentsItemName],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgentsBPID],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsGSTIN], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgentsName],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgentsGSTINNumber],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsBillType], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgentsHSNSACCode],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsBasicValue], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsIGSTRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsIGSTAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsSGSTRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsSGSTAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsCGSTRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsCGSTAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsCessRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsCessAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsTotalGST], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsTotalAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyIsgecGSTIN], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgencyStateID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgencyBillNumber],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgencyItemName],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgencyBPID],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyGSTIN], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgencyName],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgencyGSTINNumber],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyBillType], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[AgencyHSNSACCode],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyBasicValue], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyIGSTRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyIGSTAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencySGSTRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencySGSTAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyCGSTRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyCGSTAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyCessRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyCessAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyTotalGST], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyTotalAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[NonGST1TaxRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[NonGST1TaxAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[NonGST2TaxRate], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[NonGST2TaxAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[TotalPayableToAgent], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[PaxName],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[Sector],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[ReferrenceNumber],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[EmployeeID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[ProjectID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[ISGECUnit],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_AirTicket].[Geography],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[StatusID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AdviceNo], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgentsIRNo], 0)) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_AirTicket].[AgencyIRNo], 0)) LIKE @KeyWord1
   ) 
  ORDER BY

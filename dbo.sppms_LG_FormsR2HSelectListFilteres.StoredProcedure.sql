...
GO
CREATE PROCEDURE [dbo].[sppms_LG_FormsR2HSelectListFilteres]
 ...
 ,CardNo NVarChar(8) NOT NULL
  ...
  SET @LGSQL = @LGSQL + '  WHERE [PMS_FormsH].[CardNo] IN (SELECT CardNo FROM PMS_Approvers WHERE ReviewerII = ''' + @LoginID + ''' AND FinYear = ''' + @FinYear + ''' ) '

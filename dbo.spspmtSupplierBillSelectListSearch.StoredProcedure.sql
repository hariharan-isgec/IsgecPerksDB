...
GO
CREATE PROCEDURE [dbo].[spspmtSupplierBillSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 WHERE  
   ( 
         LOWER(ISNULL([SPMT_SupplierBill].[PurchaseType],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_SupplierBill].[IRNo], 0)) LIKE @KeyWord1

...
GO
CREATE PROCEDURE [dbo].[spSYS_SearchPrkApplications]
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
  ...
  WHERE STR(ISNULL([PRK_Applications].[ApplicationID], 0)) LIKE @KeyWord1
     ...
     OR STR(ISNULL([PRK_Employees6].[CategoryID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([PRK_Employees6].[PostedAt],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PRK_Employees6].[VehicleType],'')) LIKE @KeyWord1
     OR STR(ISNULL([PRK_Employees6].[Basic], 0)) LIKE @KeyWord1
     ...
     OR LOWER(ISNULL([PRK_Status7].[Description],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PRK_FinYears8].[Description],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PRK_FinYears8].[Status],'')) LIKE @KeyWord1
  ...
  + ',' + STR(ISNULL([PRK_Applications].[PostedBy],0)) 
  ...
  + ',' + STR(ISNULL([PRK_Employees6].[CategoryID],0)) 
  + ',' + ISNULL([PRK_Employees6].[PostedAt],'') 
  + ',' + ISNULL([PRK_Employees6].[VehicleType],'') 
  + ',' + STR(ISNULL([PRK_Employees6].[Basic],0)) 
  ...
  + ',' + ISNULL([PRK_Status7].[Description],'') 
  + ',' + ISNULL([PRK_FinYears8].[Description],'') 
  + ',' + ISNULL([PRK_FinYears8].[Status],'') 

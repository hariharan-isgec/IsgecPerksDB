...
GO
Create PROCEDURE [dbo].[spcost_LG_ProjectsInputACSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 WHERE  [COST_ProjectsInput].[StatusID] IN (3,4) AND  
   ( 
         LOWER(ISNULL([COST_ProjectsInput].[CurrencyGOV],'')) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[GroupOrderValue], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[CFforGOV], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[GroupOrderValueINR], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([COST_ProjectsInput].[CreatedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([COST_ProjectsInput].[ApprovedBy],'')) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[CFforBalanceCalculationByAC], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([COST_ProjectsInput].[Remarks],'')) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[ProjectRevenueByACINR], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[CFforPRByAC], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[ProjectMarginByACINR], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[ExportIncentiveByACINR], 0)) LIKE @KeyWord1
     ...
     OR LOWER(ISNULL([COST_ProjectsInput].[CurrencyPR],'')) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[ProjectGroupID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[FinYear], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[Quarter], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[CFforPR], 0)) LIKE @KeyWord1
     ...
     OR LOWER(ISNULL([COST_ProjectsInput].[CurrencyPRByAC],'')) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[ProjectRevenueINR], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[ProjectMarginINR], 0)) LIKE @KeyWord1
     OR STR(ISNULL([COST_ProjectsInput].[ExportIncentiveINR], 0)) LIKE @KeyWord1
   ) 
  ORDER BY

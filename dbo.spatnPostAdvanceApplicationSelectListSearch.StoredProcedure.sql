...
GO
CREATE PROCEDURE [dbo].[spatnPostAdvanceApplicationSelectListSearch]
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
  @ApplStatusID Int,
 ...
 WHERE  
  ...
  AND [ATN_ApplHeader].[AdvanceApplication] = @AdvanceApplication
   AND ( 
     ...
     OR LOWER(ISNULL([ATN_ExecutionStates3].[Description],'')) LIKE @KeyWord1
   ) 
  ORDER BY
     ...
     CASE @orderBy WHEN 'ATN_ExecutionStates3_ExecutionState' THEN [ATN_ExecutionStates3].[ExecutionState] END,
     CASE @orderBy WHEN 'ATN_ExecutionStates3_ExecutionState DESC' THEN [ATN_ExecutionStates3].[ExecutionState] END DESC,
     CASE @orderBy WHEN 'ATN_ExecutionStates3_Description' THEN [ATN_ExecutionStates3].[Description] END,
     CASE @orderBy WHEN 'ATN_ExecutionStates3_Description DESC' THEN [ATN_ExecutionStates3].[Description] END DESC 

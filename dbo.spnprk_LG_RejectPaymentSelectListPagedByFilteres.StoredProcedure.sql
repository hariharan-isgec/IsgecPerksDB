...
GO
CREATE PROCEDURE [dbo].[spnprk_LG_RejectPaymentSelectListPagedByFilteres]
  ...
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[UpdatedBy] = [PRK_Employees5].[EmployeeID]'
  SET @LGSQL = @LGSQL + '  INNER JOIN [PRK_Status] AS [PRK_Status6]'
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[StatusID] = [PRK_Status6].[StatusID]'
  SET @LGSQL = @LGSQL + '  INNER JOIN [PRK_FinYears] AS [PRK_FinYears7]'
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[FinYear] = [PRK_FinYears7].[FinYear]'
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'PRK_Status6_StatusID' THEN '[PRK_Status6].[StatusID]'
                        WHEN 'PRK_Status6_StatusID DESC' THEN '[PRK_Status6].[StatusID] DESC'
                        WHEN 'PRK_Status6_Description' THEN '[PRK_Status6].[Description]'
                        WHEN 'PRK_Status6_Description DESC' THEN '[PRK_Status6].[Description] DESC'
                        WHEN 'PRK_FinYears7_FinYear' THEN '[PRK_FinYears7].[FinYear]'
                        WHEN 'PRK_FinYears7_FinYear DESC' THEN '[PRK_FinYears7].[FinYear] DESC'
                        WHEN 'PRK_FinYears7_Description' THEN '[PRK_FinYears7].[Description]'
                        WHEN 'PRK_FinYears7_Description DESC' THEN '[PRK_FinYears7].[Description] DESC'
                        WHEN 'PRK_FinYears7_StartDate' THEN '[PRK_FinYears7].[StartDate]'
                        WHEN 'PRK_FinYears7_StartDate DESC' THEN '[PRK_FinYears7].[StartDate] DESC'
                        WHEN 'PRK_FinYears7_EndDate' THEN '[PRK_FinYears7].[EndDate]'
                        WHEN 'PRK_FinYears7_EndDate DESC' THEN '[PRK_FinYears7].[EndDate] DESC'
                        WHEN 'PRK_FinYears7_Status' THEN '[PRK_FinYears7].[Status]'
                        WHEN 'PRK_FinYears7_Status DESC' THEN '[PRK_FinYears7].[Status] DESC'

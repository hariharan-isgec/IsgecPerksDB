...
GO
CREATE PROCEDURE [dbo].[spadmOfficesSelectListFilteres]
  @StartRowIndex int,
  @MaximumRows int,
  @OrderBy NVarChar(50),
 ...
 ,OfficeID Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + 'OfficeID'  SET @LGSQL = @LGSQL + ')'
  SET @LGSQL = @LGSQL + ' SELECT '
  SET @LGSQL = @LGSQL + '[HRM_Offices].[OfficeID]'  SET @LGSQL = @LGSQL + ' FROM [HRM_Offices] '

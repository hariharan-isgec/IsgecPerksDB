...
GO
CREATE PROCEDURE [dbo].[spijtDesignationsSelectListFilteres]
  @StartRowIndex int,
  @MaximumRows int,
  @OrderBy NVarChar(50),
 ...
 ,DesignationID Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + 'DesignationID'  SET @LGSQL = @LGSQL + ')'
  SET @LGSQL = @LGSQL + ' SELECT '
  SET @LGSQL = @LGSQL + '[HRM_Designations].[DesignationID]'  SET @LGSQL = @LGSQL + ' FROM [HRM_Designations] '

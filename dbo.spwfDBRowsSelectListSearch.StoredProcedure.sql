...
GO
CREATE PROCEDURE [dbo].[spwfDBRowsSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 ,DBRows Int NOT NULL
  ...
  INSERT INTO #PageIndex (DashboardID, DBRows)
  SELECT [WF_DBRows].[DashboardID], [WF_DBRows].[DBRows] FROM [WF_DBRows]
 ...
 WHERE  
   ( 
         STR(ISNULL([WF_DBRows].[DashboardID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DBRows], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[Description],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[AddNewURL],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVURL],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVLaunchURL],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DBTitle],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[TitleStyle],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[cssRow],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[Sequence], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[GraphTypeID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ParentDBRows], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DBRowTypeID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[MainDBDataID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[MainDBIconID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVTypeID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVDescription],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVDBIconID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVDBDataID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVRemarksText],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVRemarksDBIconID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVForwardText],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVFDBIconID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVForwardDBDataID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVReverseText],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVRDBIconID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVReverseDBDataID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVAttachmentText],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVAttachmentDBIconID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVFASubject],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVFABodyTemplate],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVFEMailDBDataID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVFASMSText],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVFSMSDBDataID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVRASubject],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVRABodyTemplate],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVREMailDBDataID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[DVRASMSText],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[DVRSMSDBDataID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ReminderCountThreshold], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ReminderCountDBDataID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ReminderLapsDaysAvg], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ReminderAvgDBDataID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ReminderLapsDaysMax], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ReminderMaxDBDataID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ReminderFrequencyDays], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ReminderEMailDBDataID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[ReminderASubject],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[ReminderABodyTemplate],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[ReminderSMSDBDataID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[ReminderASMSText],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[AppNameLeft],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[TotSqlIDLeft], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[RedSqlIDLeft], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[AmbSqlIDLeft], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[GreSqlIDLeft], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([WF_DBRows].[AppNameRight],'')) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[TotSqlIDRight], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[RedSqlIDRight], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[AmbSqlIDRight], 0)) LIKE @KeyWord1
     OR STR(ISNULL([WF_DBRows].[GreSqlIDRight], 0)) LIKE @KeyWord1
   ) 
  ORDER BY

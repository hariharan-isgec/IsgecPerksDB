...
GO
CREATE PROCEDURE [dbo].[spsc_LG_RequestSelectListFilteres]
 ...
 ,RequestID Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + '  WHERE [aspnet_users1].[C_DivisionID] = (select C_divisionID from aspnet_users where username= ''' + @LoginID + ''')'
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'CommitteeApprovalRequired' THEN '[SC_Request].[CommitteeApprovalRequired]'
                        WHEN 'CommitteeApprovalRequired DESC' THEN '[SC_Request].[CommitteeApprovalRequired] DESC'
                        WHEN 'AuditApprovalRequired' THEN '[SC_Request].[AuditApprovalRequired]'
                        WHEN 'AuditApprovalRequired DESC' THEN '[SC_Request].[AuditApprovalRequired] DESC'
                        WHEN 'PHApprovalRequired' THEN '[SC_Request].[PHApprovalRequired]'
                        WHEN 'PHApprovalRequired DESC' THEN '[SC_Request].[PHApprovalRequired] DESC'
                        ...
                        WHEN 'BHApprovalRequired' THEN '[SC_Request].[BHApprovalRequired]'
                        WHEN 'BHApprovalRequired DESC' THEN '[SC_Request].[BHApprovalRequired] DESC'
                        ...
                        WHEN 'UnitLevelCommittee' THEN '[SC_Request].[UnitLevelCommittee]'
                        WHEN 'UnitLevelCommittee DESC' THEN '[SC_Request].[UnitLevelCommittee] DESC'

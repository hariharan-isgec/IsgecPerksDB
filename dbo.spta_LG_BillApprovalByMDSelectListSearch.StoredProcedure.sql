...
GO
CREATE Procedure [dbo].[spta_LG_BillApprovalByMDSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 ,TABillNo Int NOT NULL
  ...
  INSERT INTO #PageIndex (TABillNo)
  SELECT [TA_Bills].[TABillNo] FROM [TA_Bills]
  ...
  WHERE [TA_Bills].[BillStatusID] = 8  
    AND [TA_Bills].[EmployeeID] IN (select cardno from hrm_employees where taSanctioningAuthority = @LoginID )
 AND 
   ( 
         STR(ISNULL([TA_Bills].[TABillNo], 0)) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[TravelTypeID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[CityOfOrigin],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[DestinationCity],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ProjectID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[PurposeOfJourney],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[BriefTourReport],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ApprovedBySA],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[TotalFinancedAmount], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[SanctionDiskFile],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[BillCurrencyID],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[ApprovalWFTypeID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[DivisionID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ApprovalDiskFile],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[DesignationID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[SanctionedDA], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ERPBatchNo],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[SanctionFileName],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[CostCenterID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[CalculationTypeID],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[TotalPassedAmount], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ERPDocumentNo],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ReportDiskFile],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[SanctionedLodging], 0)) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[ComponentID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[CompanyID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ApprovedByCC],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ApprovalRemarks],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[VerifiedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[PostedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[CCRemarks],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[TotalPayableAmount], 0)) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[TotalClaimedAmount], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[EmployeeID],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[BillStatusID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ApprovedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[SARemarks],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[OOERemarks],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[OOEReasonID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[TACategoryID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ApprovalFileName],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[VerificationRemarks],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[PrjCalcType], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[DepartmentID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([TA_Bills].[ReportFileName],'')) LIKE @KeyWord1
     OR STR(ISNULL([TA_Bills].[ConversionFactorINR], 0)) LIKE @KeyWord1
   ) 
  ORDER BY

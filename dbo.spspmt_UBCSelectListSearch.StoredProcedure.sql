...
GO
CREATE Procedure [dbo].[spspmt_UBCSelectListSearch]
 ...
 ,BCID Int NOT NULL
  ...
  INSERT INTO #PageIndex (BCID)
  SELECT [SPMT_BC].[BCID] FROM [SPMT_BC]
 ...
 WHERE [SPMT_BC].[VendorID] = @Filter_VendorID 
     AND  [SPMT_BC].[BillNo] IS NULL   
     AND ( 
         STR(ISNULL([SPMT_BC].[BCID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[RequestedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[RequestedFor],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_BC].[BookingRQNo], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[VendorID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[FromPlaceID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[ToPlaceID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[AirLines],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_BC].[EstimatedAmount], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[CreatedBy],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_BC].[CancellationRQNo], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[CancelledBy],'')) LIKE @KeyWord1
     OR STR(ISNULL([SPMT_BC].[CancellationAmount], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[CancellationRemarks],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[BillLinkedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[BillNo],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[CancellationBillLinkedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([SPMT_BC].[CancellationBillNo],'')) LIKE @KeyWord1
   ) 
  ORDER BY

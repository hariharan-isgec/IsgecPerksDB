...
GO
CREATE PROCEDURE [dbo].[spwf_LG_DashboardsSelectListFilteres]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @OrderBy NVarChar(50),
 ...
 ,DashboardID Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        WHEN 'DashboardID' THEN 'Active DESC, [WF_Dashboards].[DashboardID]'
                        WHEN 'DashboardID DESC' THEN 'Active DESC, [WF_Dashboards].[DashboardID] DESC'
                        ...
                        WHEN 'IconStyle' THEN '[WF_Dashboards].[IconStyle]'
                        WHEN 'IconStyle DESC' THEN '[WF_Dashboards].[IconStyle] DESC'

...
GO
CREATE PROCEDURE [dbo].[spqcm_LG_IEntryFieldSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 ,RequestID Int NOT NULL
  ...
  WHERE [QCM_Requests].[RequestStateID] IN ('ALLOTED','INSPECTED','CLOSED')
     AND [QCM_Requests].[AllotedTo] =  @LoginID 
     AND ( 

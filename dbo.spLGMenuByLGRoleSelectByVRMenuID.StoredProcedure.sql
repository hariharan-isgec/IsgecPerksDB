...
GO
CREATE PROCEDURE [dbo].[spLGMenuByLGRoleSelectByVRMenuID]
  @VRMenuID Int,
  @OrderBy NVarChar(50),
  ...
  WHERE
  [SYS_VRMenuByVRRole].[VRMenuID] = @VRMenuID
  ORDER BY
     ...
     CASE @orderBy WHEN 'SYS_Applications3_GenerateDefaults' THEN [SYS_Applications3].[GenerateDefaults] END,
     CASE @orderBy WHEN 'SYS_Applications3_GenerateDefaults DESC' THEN [SYS_Applications3].[GenerateDefaults] END DESC 

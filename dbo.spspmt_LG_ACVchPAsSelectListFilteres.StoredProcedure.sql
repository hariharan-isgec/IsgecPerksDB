...
GO
CREATE Procedure [dbo].[spspmt_LG_ACVchPAsSelectListFilteres]
  @Filter_VoucherNo Int,
  @StartRowIndex int,
  @MaximumRows int,
  @OrderBy NVarChar(50),
 ...
 ,AdviceNo Int NOT NULL
  ...
  IF (@Filter_VoucherNo > 0) 
    SET @LGSQL = @LGSQL + ' AND [SPMT_PaymentAdvice].[VoucherNo] = ' + STR(@Filter_VoucherNo)

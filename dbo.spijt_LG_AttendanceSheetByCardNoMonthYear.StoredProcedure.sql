...
GO
CREATE PROCEDURE [dbo].[spijt_LG_AttendanceSheetByCardNoMonthYear]
  @CardNo NVarChar(8),
  @DataMonth Int,
  @FinYear Int
  AS
  ...
  WHERE
  [IJT_Attendance].[CardNo] = @CardNo
  AND [IJT_Attendance].[DataMonth] = @DataMonth
  AND [IJT_Attendance].[FinYear] = @FinYear
GO

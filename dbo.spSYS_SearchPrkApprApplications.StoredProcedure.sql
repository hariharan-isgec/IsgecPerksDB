...
GO
CREATE PROCEDURE [dbo].[spSYS_SearchPrkApprApplications]
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
  ...
  WHERE STR(ISNULL([PRK_Applications].[ApplicationID], 0)) LIKE @KeyWord1
     ...
     OR LOWER(ISNULL([PRK_Status5].[Description],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PRK_FinYears6].[Description],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PRK_FinYears6].[Status],'')) LIKE @KeyWord1
  ...
  + ',' + ISNULL([PRK_Status5].[Description],'') 
  + ',' + ISNULL([PRK_FinYears6].[Description],'') 
  + ',' + ISNULL([PRK_FinYears6].[Status],'') 

...
GO
CREATE VIEW [dbo].[ATNv_FirstPunchAnalysis]
AS
SELECT     dbo.ATN_Attendance.CardNo, dbo.ATN_Attendance.AttenDate, dbo.HRM_Employees.EmployeeName, ISNULL(dbo.HRM_Employees.C_OfficeID, N'') 
                      ...
                      AS Category_Description, dbo.ATN_Attendance.PunchStatusID, dbo.ATN_Attendance.Applied
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[39] 4[18] 2[24] 3) )"
      End
...
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_FirstPunchAnalysis'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'         Column = 4155
         Alias = 2010
         Table = 1170
         Output = 720
         Append = 1400
...
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_FirstPunchAnalysis'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_FirstPunchAnalysis'
GO

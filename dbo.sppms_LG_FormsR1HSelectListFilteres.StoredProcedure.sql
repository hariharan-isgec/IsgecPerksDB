...
GO
CREATE PROCEDURE [dbo].[sppms_LG_FormsR1HSelectListFilteres]
 ...
 ,CardNo NVarChar(8) NOT NULL
  ...
  SET @LGSQL = @LGSQL + '  WHERE [PMS_FormsH].[CardNo] IN (SELECT CardNo FROM PMS_Approvers WHERE ReviewerI = ''' + @LoginID + ''' AND FinYear = ''' + @FinYear + ''' ) '

...
GO
CREATE PROCEDURE [dbo].[sptlwDesignationsSelectListFilteres]
  @Filter_DesignationID Int,
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @OrderBy NVarChar(50),
 ...
 ,DesignationID Int NOT NULL
  ...
  IF (@Filter_DesignationID > 0) 
    SET @LGSQL = @LGSQL + ' AND [HRM_Designations].[DesignationID] = ' + STR(@Filter_DesignationID)

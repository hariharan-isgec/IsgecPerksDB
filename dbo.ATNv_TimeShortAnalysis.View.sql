...
GO
CREATE VIEW [dbo].[ATNv_TimeShortAnalysis]
AS
SELECT     dbo.ATN_Attendance.CardNo, dbo.ATN_Attendance.AttenDate, dbo.HRM_Employees.EmployeeName, ISNULL(dbo.HRM_Employees.C_OfficeID, N'') 
                      ...
                      AS Applied1LeaveTypeID, ISNULL(dbo.ATN_Attendance.Applied2LeaveTypeID, N'') AS Applied2LeaveTypeID, ISNULL(dbo.ATN_Attendance.TSStatus, '') 
                      AS TSStatus
...
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_TimeShortAnalysis'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'         Column = 3450
         Alias = 900
         Table = 1170
         Output = 720
         Append = 1400
...
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_TimeShortAnalysis'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_TimeShortAnalysis'
GO

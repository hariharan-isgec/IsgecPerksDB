...
GO
create PROCEDURE [dbo].[spijt_LG_AttendanceSelectListFilteres_Must be deleted]
 ...
 ,RecordID Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + ' AND [ATNv_SiteAttendance].[ProjectID] = ''' + @ProjectID + ''''
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'Locked' THEN '[ATNv_SiteAttendance].[Locked]'
                        WHEN 'Locked DESC' THEN '[ATNv_SiteAttendance].[Locked] DESC'
                        WHEN 'Remarks' THEN '[ATNv_SiteAttendance].[Remarks]'
                        WHEN 'Remarks DESC' THEN '[ATNv_SiteAttendance].[Remarks] DESC'
                        WHEN 'ProjectID' THEN '[ATNv_SiteAttendance].[ProjectID]'
                        WHEN 'ProjectID DESC' THEN '[ATNv_SiteAttendance].[ProjectID] DESC'
                        WHEN 'ATN_FinYear1_FinYear' THEN '[ATN_FinYear1].[FinYear]'
                        WHEN 'ATN_FinYear1_FinYear DESC' THEN '[ATN_FinYear1].[FinYear] DESC'
                        WHEN 'ATN_FinYear1_Description' THEN '[ATN_FinYear1].[Description]'
                        WHEN 'ATN_FinYear1_Description DESC' THEN '[ATN_FinYear1].[Description] DESC'
                        WHEN 'ATN_Months2_MonthID' THEN '[ATN_Months2].[MonthID]'
                        WHEN 'ATN_Months2_MonthID DESC' THEN '[ATN_Months2].[MonthID] DESC'
                        WHEN 'ATN_Months2_Description' THEN '[ATN_Months2].[Description]'
                        WHEN 'ATN_Months2_Description DESC' THEN '[ATN_Months2].[Description] DESC'

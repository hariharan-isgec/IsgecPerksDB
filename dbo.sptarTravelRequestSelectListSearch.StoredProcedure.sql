...
GO
CREATE PROCEDURE [dbo].[sptarTravelRequestSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 WHERE [TA_TravelRequest].[CreatedBy] = case when @LoginID <> '0340' then @LoginID else [TA_TravelRequest].[CreatedBy] end 
    AND ( 

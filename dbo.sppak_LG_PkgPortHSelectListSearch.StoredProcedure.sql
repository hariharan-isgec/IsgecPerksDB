...
GO
CREATE PROCEDURE [dbo].[sppak_LG_PkgPortHSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 WHERE  [PAK_PkgListH].[PortID] IN (Select PortID from PAK_UserPort where UserID = @LoginID )
     AND [PAK_PkgListH].[SerialNo] = 0
     AND ( 

...
GO
CREATE PROCEDURE [dbo].[spqcm_LG_RequestsSelectByCreationDate]
  @ForDate DateTime,
  @LoginID NVarChar(8),
  @OrderBy NVarChar(50),
  ...
  WHERE
  [QCM_Requests].[CreatedOn] = @ForDate 
	AND [QCM_Requests].[RequestStateID] = 'ALLOTED' 
  AND [QCM_Requests].[AllotedTo] NOT IN ('1356','1204','0083','0511')  
  ORDER BY

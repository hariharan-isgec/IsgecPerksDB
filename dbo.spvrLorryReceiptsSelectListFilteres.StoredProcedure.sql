...
CREATE PROCEDURE [dbo].[spvrLorryReceiptsSelectListFilteres]
 ...
 ,MRNNo Int NOT NULL
  ...
  IF (@Filter_LRStatusID > 0) 
    SET @LGSQL = @LGSQL + ' AND [VR_LorryReceipts].[LRStatusID] = ' + STR(@Filter_LRStatusID)

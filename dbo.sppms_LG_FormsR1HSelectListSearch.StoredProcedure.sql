...
GO
create PROCEDURE [dbo].[sppms_LG_FormsR1HSelectListSearch]
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
  @FinYear NVarChar(4),
 ...
 WHERE [PMS_FormsH].[CardNo] IN (SELECT CardNo FROM PMS_Approvers WHERE ReviewerI =  @LoginID  AND FinYear =  @FinYear  ) 

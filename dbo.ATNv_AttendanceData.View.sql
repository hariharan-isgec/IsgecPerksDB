...
GO
CREATE VIEW [dbo].[ATNv_AttendanceData]  
AS
SELECT     dbo.ATN_Attendance.CardNo, dbo.ATN_Attendance.AttenDate, dbo.HRM_Employees.EmployeeName, ISNULL(dbo.HRM_Employees.C_OfficeID, N'') 
                      ...
                      AS Category_Description, dbo.ATN_Attendance.PunchStatusID, ISNULL(dbo.ATN_Attendance.Applied1LeaveTypeID, N'') AS Applied1LeaveTypeID, 
                      ISNULL(dbo.ATN_Attendance.Applied2LeaveTypeID, N'') AS Applied2LeaveTypeID, ISNULL(dbo.ATN_Attendance.Destination, N'') AS Destination, 
                      ISNULL(dbo.ATN_Attendance.Purpose, N'') AS Purpose
...
WHERE     (dbo.ATN_Attendance.PunchStatusID <> N'WO') AND (dbo.ATN_Attendance.PunchStatusID <> N'HD')
GO
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[30] 4[40] 2[23] 3) )"
      End
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 14
         Width = 284
         Widt' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_AttendanceData'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'h = 1500
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_AttendanceData'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_AttendanceData'
GO

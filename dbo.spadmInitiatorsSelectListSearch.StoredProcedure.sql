...
GO
CREATE PROCEDURE [dbo].[spadmInitiatorsSelectListSearch]
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
  @OrderBy NVarChar(50),
 ...
 ,InitiatorID NVarChar(8) NOT NULL
  ...
  INSERT INTO #PageIndex (ServiceID, InitiatorID)
  SELECT [ADM_Initiators].[ServiceID], [ADM_Initiators].[InitiatorID] FROM [ADM_Initiators]
 ...
 WHERE  
   ( 
         LOWER(ISNULL([ADM_Initiators].[ServiceID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([ADM_Initiators].[InitiatorID],'')) LIKE @KeyWord1

...
GO
CREATE PROCEDURE [dbo].[spadmQualificationsSelectListFilteres]
  @StartRowIndex int,
  @MaximumRows int,
  @OrderBy NVarChar(50),
 ...
 ,QualificationID Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + 'QualificationID'  SET @LGSQL = @LGSQL + ')'
  SET @LGSQL = @LGSQL + ' SELECT '
  SET @LGSQL = @LGSQL + '[HRM_Qualifications].[QualificationID]'  SET @LGSQL = @LGSQL + ' FROM [HRM_Qualifications] '

...
GO
CREATE PROCEDURE [dbo].[spnprk_LG_RECUserClaimsSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 ,ClaimID Int NOT NULL
  ...
  WHERE [PRK_UserClaims].[FinYear] = (SELECT TOP 1 [PRK_FinYears].[FinYear] FROM [PRK_FinYears] WHERE [PRK_FinYears].[Status] = 'Open') 
   AND   [PRK_UserClaims].[ClaimStatusID] = @ClaimStatusID  
   AND ( 

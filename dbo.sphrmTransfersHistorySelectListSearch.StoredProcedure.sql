...
GO
CREATE PROCEDURE [dbo].[sphrmTransfersHistorySelectListSearch]
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
  @Executed Bit,
 ...
 WHERE (([HRM_Transfers].[OfficeID]=6 AND [HRM_Transfers].[VerifiedBy] IS NOT NULL) OR ([HRM_Transfers].[OfficeID] <> 6 AND [HRM_Transfers].[VerifiedBy] IS NULL )) 

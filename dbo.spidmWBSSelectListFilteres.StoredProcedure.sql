...
GO
CREATE PROCEDURE [dbo].[spidmWBSSelectListFilteres]
 ...
 ,WBSID NVarChar(8) NOT NULL
  ...
  IF (@Filter_ResponsibleAgencyID > 0) 
    SET @LGSQL = @LGSQL + ' AND [IDM_WBS].[ResponsibleAgencyID] = ' + STR(@Filter_ResponsibleAgencyID)
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'IDM_ResponsibleAgency1_Description' THEN '[IDM_ResponsibleAgency].[Description]'

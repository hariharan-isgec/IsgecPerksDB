...
GO
CREATE PROCEDURE [dbo].[sppakSitePkgHSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 ,RecNo Int NOT NULL
  ...
  INSERT INTO #PageIndex (ProjectID, RecNo)
  SELECT [PAK_SitePkgH].[ProjectID], [PAK_SitePkgH].[RecNo] FROM [PAK_SitePkgH]
 ...
 WHERE  
   ( 
         LOWER(ISNULL([PAK_SitePkgH].[ProjectID],'')) LIKE @KeyWord1
     OR STR(ISNULL([PAK_SitePkgH].[RecNo], 0)) LIKE @KeyWord1
     OR STR(ISNULL([PAK_SitePkgH].[SerialNo], 0)) LIKE @KeyWord1
     OR STR(ISNULL([PAK_SitePkgH].[PkgNo], 0)) LIKE @KeyWord1
     OR STR(ISNULL([PAK_SitePkgH].[MRNNo], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([PAK_SitePkgH].[SupplierID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PAK_SitePkgH].[SupplierName],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PAK_SitePkgH].[SupplierRefNo],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PAK_SitePkgH].[TransporterID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PAK_SitePkgH].[TransporterName],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PAK_SitePkgH].[VehicleNo],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PAK_SitePkgH].[GRNo],'')) LIKE @KeyWord1
     OR STR(ISNULL([PAK_SitePkgH].[UOMTotalWeight], 0)) LIKE @KeyWord1
     OR STR(ISNULL([PAK_SitePkgH].[TotalWeight], 0)) LIKE @KeyWord1
     OR STR(ISNULL([PAK_SitePkgH].[MaterialStatusID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([PAK_SitePkgH].[Remarks],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([PAK_SitePkgH].[CreatedBy],'')) LIKE @KeyWord1
     OR STR(ISNULL([PAK_SitePkgH].[ReceiveStatusID], 0)) LIKE @KeyWord1
   ) 
  ORDER BY

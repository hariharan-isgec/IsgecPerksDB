...
GO
CREATE Procedure [dbo].[sp_Insert_PreOrder_Workflow_History]
@WFID int,
@Parent_WFID int,
@Project	varchar(50),
@Element	varchar(50),
...
INSERT INTO [IJTPerks].[dbo].[WF1_PreOrder_History]
           ...
           ,[Notes])
     VALUES
   (@WF_HistoryID,@WFID,@WF_SlNo,@Parent_WFID,@Project,@Element,@SpecificationNo,@PMDLDocNo,@Buyer,@WF_Status,@UserId,getDate(),@Supplier,@SupplierName,@Notes)

...
GO
CREATE PROCEDURE [dbo].[spvr_LG_RequestExecutionLinkedSelectListSearch]
  @Filter_LinkID Int,
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
 ...
 WHERE  [VR_RequestExecution].[LinkID]= @Filter_LinkID    
   AND [VR_RequestExecution].[Linked] = 1 
   AND [VR_RequestExecution].[SRNNo] <> [VR_RequestExecution].[LinkID] 
   AND ( 

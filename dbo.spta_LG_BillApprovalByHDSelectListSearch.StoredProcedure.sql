...
GO
CREATE Procedure [dbo].[spta_LG_BillApprovalByHDSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 ,TABillNo Int NOT NULL
  ...
  WHERE [TA_Bills].[BillStatusID] = 10  
    AND [TA_Bills].[EmployeeID] IN (select cardno from hrm_employees where taVerifier = @LoginID )
    AND      
   ( 

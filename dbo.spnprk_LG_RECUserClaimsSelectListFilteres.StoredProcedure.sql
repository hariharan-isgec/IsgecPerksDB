...
GO
CREATE PROCEDURE [dbo].[spnprk_LG_RECUserClaimsSelectListFilteres]
 ...
 ,ClaimID Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + '  WHERE [PRK_UserClaims].[FinYear] = (SELECT TOP 1 [PRK_FinYears].[FinYear] FROM [PRK_FinYears] WHERE [PRK_FinYears].[Status] = ''Open'') '

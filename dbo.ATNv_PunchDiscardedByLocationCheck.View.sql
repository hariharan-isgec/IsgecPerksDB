...
GO
CREATE VIEW [dbo].[ATNv_PunchDiscardedByLocationCheck]
AS
...
WHERE     APPLIED=0 AND(dbo.ATN_Attendance.AttenDate >= (GetDate()-15)) AND (dbo.ATN_Attendance.Punch1Time > 0) AND 
                      (dbo.ATN_Attendance.Punch2Time <= 0) AND (dbo.ATN_Attendance.CardNo IN
                          (SELECT     CardNo
                            FROM          dbo.ATN_RawPunch
                            WHERE      (PunchDate = ATN_Attendance.AttenDate) AND (Punch1Time > 0) AND (Punch2Time > 0)))
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[27] 4[18] 2[16] 3) )"
      End
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_PunchDiscardedByLocationCheck'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ATNv_PunchDiscardedByLocationCheck'
GO

...
GO
CREATE PROCEDURE [dbo].[spidmTDSelectByID]
  @TmtlID Int,
  ...
  AND [IDM_TransmittalDetail].[ProjectID] = @ProjectID
  AND [IDM_TransmittalDetail].[DocumentID] = @DocumentID
  AND [IDM_TransmittalDetail].[RevisionNo] = @RevisionNo
GO

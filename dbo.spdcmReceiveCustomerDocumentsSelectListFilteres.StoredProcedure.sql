...
GO
CREATE PROCEDURE [dbo].[spdcmReceiveCustomerDocumentsSelectListFilteres]
 ...
 ,RevisionNo NVarChar(2) NOT NULL
  ...
  SET @LGSQL = @LGSQL + '[DCM_CustomerTmtlDetails].[TmtlID]'  SET @LGSQL = @LGSQL + ', [DCM_CustomerTmtlDetails].[ProjectID]'  SET @LGSQL = @LGSQL + ', [DCM_CustomerTmtlDetails].[CustomerID]'  SET @LGSQL = @LGSQL + ', [DCM_CustomerTmtlDetails].[DocumentID]'  SET @LGSQL = @LGSQL + ', [DCM_CustomerTmtlDetails].[RevisionNo]'  SET @LGSQL = @LGSQL + ' FROM [DCM_CustomerTmtlDetails] '
  ...
  IF (@Filter_ProjectID > '') 
    SET @LGSQL = @LGSQL + ' AND [DCM_CustomerTmtlDetails].[ProjectID] = ''' + @Filter_ProjectID + ''''
  SET @LGSQL = @LGSQL + ' AND [DCM_CustomerTmtlDetails].[TempDetailStatus] = ' + STR(@TempDetailStatus)
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'TempDetailStatus' THEN '[DCM_CustomerTmtlDetails].[TempDetailStatus]'
                        WHEN 'TempDetailStatus DESC' THEN '[DCM_CustomerTmtlDetails].[TempDetailStatus] DESC'
  ...
  SELECT
		...
		[DCM_CustomerTmtlDetails].[TempDetailStatus],

...
GO
CREATE PROCEDURE [dbo].[spadmITEventStatusSelectListFilteres]
  @Filter_EventID Int,
  @Filter_ITServiceID NVarChar(15),
  @StartRowIndex int,
  @MaximumRows int,
  @OrderBy NVarChar(50),
 ...
 ,ITServiceID NVarChar(15) NOT NULL
  ...
  IF (@Filter_ITServiceID > '') 
    SET @LGSQL = @LGSQL + ' AND [ADM_ITEventStatus].[ITServiceID] = ''' + @Filter_ITServiceID + ''''

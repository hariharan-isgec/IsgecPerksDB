...
GO
CREATE PROCEDURE [dbo].[sppms_LG_FormsAHSelectListSearch]
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
  @FinYear NVarChar(4),
 ...
 WHERE [PMS_FormsH].[CardNo] IN (SELECT CardNo FROM PMS_Approvers WHERE Apparaiser =  @LoginID  AND FinYear =  @FinYear  ) 

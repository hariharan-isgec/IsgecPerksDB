...
GO
CREATE PROCEDURE [dbo].[spcalRegisterUserComplaintsSelectListSearch]
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
  @OrderBy NVarChar(50),
 ...
 WHERE  
   ( 
     ...
     OR LOWER(ISNULL([CAL_Priority4].[Priority],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([CAL_Priority4].[Description],'')) LIKE @KeyWord1
  ...
  ORDER BY
     ...
     CASE @orderBy WHEN 'CAL_Priority4_Priority' THEN [CAL_Priority4].[Priority] END,
     CASE @orderBy WHEN 'CAL_Priority4_Priority DESC' THEN [CAL_Priority4].[Priority] END DESC,
     CASE @orderBy WHEN 'CAL_Priority4_Description' THEN [CAL_Priority4].[Description] END,
     CASE @orderBy WHEN 'CAL_Priority4_Description DESC' THEN [CAL_Priority4].[Description] END DESC,

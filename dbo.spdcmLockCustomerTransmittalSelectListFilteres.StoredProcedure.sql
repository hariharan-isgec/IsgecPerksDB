...
GO
CREATE PROCEDURE [dbo].[spdcmLockCustomerTransmittalSelectListFilteres]
  @StartRowIndex int,
  @MaximumRows int,
 ...
 ,CustomerID NVarChar(6) NOT NULL
  ...
  SET @LGSQL = @LGSQL + '    ON [DCM_CustomerTmtlHeader].[CreatedBy] = [HRM_Employees1].[CardNo]'
  SET @LGSQL = @LGSQL + '  WHERE 1 = 1 '
  SET @LGSQL = @LGSQL + ' AND [DCM_CustomerTmtlHeader].[TmtlStatusID] = ''' + @TmtlStatusID + ''''

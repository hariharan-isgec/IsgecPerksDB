...
GO
CREATE PROCEDURE [dbo].[spatnPostAdvanceApplicationSelectListFilteres]
  ...
  SET @LGSQL = @LGSQL + '  LEFT OUTER JOIN [ATN_ExecutionStates] AS [ATN_ExecutionStates3]'
  SET @LGSQL = @LGSQL + '    ON [ATN_ApplHeader].[ExecutionState] = [ATN_ExecutionStates3].[ExecutionState]'
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'ATN_ExecutionStates3_ExecutionState' THEN '[ATN_ExecutionStates3].[ExecutionState]'
                        WHEN 'ATN_ExecutionStates3_ExecutionState DESC' THEN '[ATN_ExecutionStates3].[ExecutionState] DESC'
                        WHEN 'ATN_ExecutionStates3_Description' THEN '[ATN_ExecutionStates3].[Description]'
                        WHEN 'ATN_ExecutionStates3_Description DESC' THEN '[ATN_ExecutionStates3].[Description] DESC'

...
GO
CREATE PROCEDURE [dbo].[sppak_LG_UItemsSelectListFilteres]
 ...
 ,ItemNo Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + '  WHERE [PAK_Items].[ItemNo] NOT IN (SELECT ItemNo from PAK_POBOM where SerialNo= ' + @SerialNo + ') '

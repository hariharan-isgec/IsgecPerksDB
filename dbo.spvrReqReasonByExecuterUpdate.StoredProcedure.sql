...
GO
CREATE PROCEDURE [dbo].[spvrReqReasonByExecuterUpdate]
  ...
  @ExecuterReasonID Int,
  @ExecuterID NVarChar(8),
  @ReasonEneteredOn DateTime,
  ...
  ,[ExecuterReasonID] = @ExecuterReasonID
  ,[ExecuterID] = @ExecuterID
  ,[ReasonEneteredOn] = @ReasonEneteredOn
  WHERE

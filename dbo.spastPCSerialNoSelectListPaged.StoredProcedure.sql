...
GO
CREATE PROCEDURE [dbo].[spastPCSerialNoSelectListPaged]
  @StartRowIndex int,
  @MaximumRows int,
  @Discarded Bit,
  @OrderBy NVarChar(50),
  ...
  ORDER BY
     ...
     CASE @orderBy WHEN 'AST_Rams4_RamID' THEN [AST_Rams4].[RamID] END,
     CASE @orderBy WHEN 'AST_Rams4_RamID DESC' THEN [AST_Rams4].[RamID] END DESC,
     CASE @orderBy WHEN 'AST_Rams4_Description' THEN [AST_Rams4].[Description] END,
     CASE @orderBy WHEN 'AST_Rams4_Description DESC' THEN [AST_Rams4].[Description] END DESC,
     ...
     CASE @orderBy WHEN 'AST_Locations6_LocationID' THEN [AST_Locations6].[LocationID] END,
     CASE @orderBy WHEN 'AST_Locations6_LocationID DESC' THEN [AST_Locations6].[LocationID] END DESC,
     CASE @orderBy WHEN 'AST_Locations6_Descriptions' THEN [AST_Locations6].[Descriptions] END,
     CASE @orderBy WHEN 'AST_Locations6_Descriptions DESC' THEN [AST_Locations6].[Descriptions] END DESC,

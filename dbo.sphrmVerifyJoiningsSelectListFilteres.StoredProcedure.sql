...
GO
CREATE PROCEDURE [dbo].[sphrmVerifyJoiningsSelectListFilteres]
  @StartRowIndex int,
  @MaximumRows int,
  @Freezed Bit,
  @OrderBy NVarChar(50),
  ...
  SET @LGSQL = @LGSQL + '    ON [HRM_Employees].[ModifiedBy] = [aspnet_Users8].[UserName]'
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'aspnet_Users8_UserName' THEN '[aspnet_Users8].[UserName]'
                        WHEN 'aspnet_Users8_UserName DESC' THEN '[aspnet_Users8].[UserName] DESC'

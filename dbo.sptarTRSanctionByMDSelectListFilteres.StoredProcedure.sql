...
GO
CREATE PROCEDURE [dbo].[sptarTRSanctionByMDSelectListFilteres]
 ...
 ,RequestID Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + '  WHERE [TA_TravelRequest].[StatusID] IN (9,10) AND [TA_TravelRequest].[TravelTypeID] IN (2,3) '
  IF (@Filter_ProjectID > '') 

...
GO
CREATE PROCEDURE [dbo].[sptaCDAccountsSelectListSearch]
  @Filter_TABillNo Int,
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
 ...
 WHERE  
   ...
   AND ( 
         STR(ISNULL([TA_BillDetails].[SerialNo], 0)) LIKE @KeyWord1
     ...
     OR STR(ISNULL([TA_BillDetails].[TABillNo], 0)) LIKE @KeyWord1

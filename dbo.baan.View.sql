...
GO
CREATE VIEW [dbo].[baan]
AS
SELECT     IRNO, IRDATE, SUPPLIERCODE, SUPPLIERNAME, PROJECTCODE, PROJECTNAME, SUPPLIERBILLNO, SUPPLIERBILLDATE, AMOUNT
FROM         OPENQUERY(baan, 
                      'select T$NINV as IRNo, 
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[20] 4[18] 2[41] 3) )"
      End
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'baan'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'baan'
GO

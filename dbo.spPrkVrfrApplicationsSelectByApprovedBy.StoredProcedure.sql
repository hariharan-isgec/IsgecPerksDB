...
GO
CREATE PROCEDURE [dbo].[spPrkVrfrApplicationsSelectByApprovedBy]
  @StatusID Int,
  @FinYear Int,
  @ApprovedBy Int,
  @OrderBy NVarChar(50),
  ...
  ORDER BY
     ...
     CASE @orderBy WHEN 'PRK_Status5_StatusID' THEN [PRK_Status5].[StatusID] END,
     CASE @orderBy WHEN 'PRK_Status5_StatusID DESC' THEN [PRK_Status5].[StatusID] END DESC,
     CASE @orderBy WHEN 'PRK_Status5_Description' THEN [PRK_Status5].[Description] END,
     CASE @orderBy WHEN 'PRK_Status5_Description DESC' THEN [PRK_Status5].[Description] END DESC,
     CASE @orderBy WHEN 'PRK_FinYears6_FinYear' THEN [PRK_FinYears6].[FinYear] END,
     CASE @orderBy WHEN 'PRK_FinYears6_FinYear DESC' THEN [PRK_FinYears6].[FinYear] END DESC,
     ...
     CASE @orderBy WHEN 'PRK_FinYears6_StartDate' THEN [PRK_FinYears6].[StartDate] END,
     CASE @orderBy WHEN 'PRK_FinYears6_StartDate DESC' THEN [PRK_FinYears6].[StartDate] END DESC,
     CASE @orderBy WHEN 'PRK_FinYears6_EndDate' THEN [PRK_FinYears6].[EndDate] END,
     CASE @orderBy WHEN 'PRK_FinYears6_EndDate DESC' THEN [PRK_FinYears6].[EndDate] END DESC,
     CASE @orderBy WHEN 'PRK_FinYears6_Status' THEN [PRK_FinYears6].[Status] END,
     CASE @orderBy WHEN 'PRK_FinYears6_Status DESC' THEN [PRK_FinYears6].[Status] END DESC 

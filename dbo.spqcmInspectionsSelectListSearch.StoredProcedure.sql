...
GO
CREATE PROCEDURE [dbo].[spqcmInspectionsSelectListSearch]
  @LoginID NVarChar(8),
  @StartRowIndex int,
  @MaximumRows int,
  @KeyWord VarChar(250),
 ...
 ,InspectionID Int NOT NULL
  ...
  INSERT INTO #PageIndex (RequestID, InspectionID)
  SELECT [QCM_Inspections].[RequestID], [QCM_Inspections].[InspectionID] FROM [QCM_Inspections]
 ...
 WHERE  
   ( 
         STR(ISNULL([QCM_Inspections].[RequestID], 0)) LIKE @KeyWord1
     OR STR(ISNULL([QCM_Inspections].[InspectionID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([QCM_Inspections].[ProjectID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([QCM_Inspections].[OrderNo],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([QCM_Inspections].[SupplierID],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([QCM_Inspections].[InspectionRemarks],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([QCM_Inspections].[InspectedBy],'')) LIKE @KeyWord1
     OR LOWER(ISNULL([QCM_Inspections].[RequestStateID],'')) LIKE @KeyWord1
     OR STR(ISNULL([QCM_Inspections].[InspectionStatusID], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([QCM_Inspections].[InspectedQuantity],'')) LIKE @KeyWord1
     OR STR(ISNULL([QCM_Inspections].[InspectionStageiD], 0)) LIKE @KeyWord1
     OR LOWER(ISNULL([QCM_Inspections].[EnteredBy],'')) LIKE @KeyWord1
   ) 
  ORDER BY

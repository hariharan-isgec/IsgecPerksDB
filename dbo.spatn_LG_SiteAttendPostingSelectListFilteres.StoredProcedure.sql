...
GO
Create PROCEDURE [dbo].[spatn_LG_SiteAttendPostingSelectListFilteres]
  @Filter_MonthID Int,
 ...
 ,CardNo NVarChar(8) NOT NULL
  ...
  if (@Posted = 1) 
    SET @LGSQL = @LGSQL + '  AND [ATN_SiteAttendance].[ATNStatusID] = 6 ' --Posted
  Else
    SET @LGSQL = @LGSQL + '  AND [ATN_SiteAttendance].[ATNStatusID] = 5 ' --Under Posting

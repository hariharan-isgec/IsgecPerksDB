...
GO
CREATE PROCEDURE [dbo].[spLGMenuByLGRoleSelectListFilteres]
  @StartRowIndex int,
  @MaximumRows int,
  @OrderBy NVarChar(50),
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'SYS_VRRoles1_DefaultRole' THEN '[SYS_VRRoles1].[DefaultRole]'
                        WHEN 'SYS_VRRoles1_DefaultRole DESC' THEN '[SYS_VRRoles1].[DefaultRole] DESC'

...
WHERE        (PunchStatusID = 'AS') AND (Applied2LeaveTypeID <> 'OD' OR
                         ...
                         Applied2LeaveTypeID IS NULL) AND (MONTH(AttenDate) = 8) AND (YEAR(AttenDate) = 2018) OR
                         (PunchStatusID = 'AF') AND (MONTH(AttenDate) = 8) AND (YEAR(AttenDate) = 2018) AND (Applied1LeaveTypeID <> 'OD' OR
                         Applied1LeaveTypeID <> 'SP' OR
                         Applied1LeaveTypeID IS NULL) OR
                         (PunchStatusID = 'AD') AND (MONTH(AttenDate) = 8) AND (YEAR(AttenDate) = 2018) AND (Applied1LeaveTypeID <> 'OD' OR
                         Applied1LeaveTypeID <> 'SP' OR

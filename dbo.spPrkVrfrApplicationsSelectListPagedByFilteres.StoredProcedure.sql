...
GO
CREATE PROCEDURE [dbo].[spPrkVrfrApplicationsSelectListPagedByFilteres]
  ...
  SET @LGSQL = @LGSQL + '  INNER JOIN [PRK_Status] AS [PRK_Status4]'
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[StatusID] = [PRK_Status4].[StatusID]'
  SET @LGSQL = @LGSQL + '  INNER JOIN [PRK_FinYears] AS [PRK_FinYears5]'
  SET @LGSQL = @LGSQL + '    ON [PRK_Applications].[FinYear] = [PRK_FinYears5].[FinYear]'
  ...
  SET @LGSQL = @LGSQL + CASE @OrderBy
                        ...
                        WHEN 'PRK_Status4_StatusID' THEN '[PRK_Status4].[StatusID]'
                        WHEN 'PRK_Status4_StatusID DESC' THEN '[PRK_Status4].[StatusID] DESC'
                        WHEN 'PRK_Status4_Description' THEN '[PRK_Status4].[Description]'
                        WHEN 'PRK_Status4_Description DESC' THEN '[PRK_Status4].[Description] DESC'
                        WHEN 'PRK_FinYears5_FinYear' THEN '[PRK_FinYears5].[FinYear]'
                        WHEN 'PRK_FinYears5_FinYear DESC' THEN '[PRK_FinYears5].[FinYear] DESC'
                        WHEN 'PRK_FinYears5_Description' THEN '[PRK_FinYears5].[Description]'
                        WHEN 'PRK_FinYears5_Description DESC' THEN '[PRK_FinYears5].[Description] DESC'
                        WHEN 'PRK_FinYears5_StartDate' THEN '[PRK_FinYears5].[StartDate]'
                        WHEN 'PRK_FinYears5_StartDate DESC' THEN '[PRK_FinYears5].[StartDate] DESC'
                        WHEN 'PRK_FinYears5_EndDate' THEN '[PRK_FinYears5].[EndDate]'
                        WHEN 'PRK_FinYears5_EndDate DESC' THEN '[PRK_FinYears5].[EndDate] DESC'
                        WHEN 'PRK_FinYears5_Status' THEN '[PRK_FinYears5].[Status]'
                        WHEN 'PRK_FinYears5_Status DESC' THEN '[PRK_FinYears5].[Status] DESC'

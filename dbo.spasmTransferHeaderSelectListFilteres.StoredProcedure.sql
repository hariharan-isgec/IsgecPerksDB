...
GO
CREATE PROCEDURE [dbo].[spasmTransferHeaderSelectListFilteres]
  @StartRowIndex int,
  @MaximumRows int,
  @OrderBy NVarChar(50),
 ...
 ,TransferID Int NOT NULL
  ...
  SET @LGSQL = @LGSQL + '  INNER JOIN [HRM_Offices] AS [HRM_Offices9]'
  SET @LGSQL = @LGSQL + '    ON [ASM_TransferHeader].[TransferFrom] = [HRM_Offices9].[OfficeID]'
